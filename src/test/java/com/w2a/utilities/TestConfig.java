...
public class TestConfig {
	...
	public static String from = "pranavj2009@gmail.com";
	public static String password = "czcmadrgrkzfandm";
	public static String[] to = { "pranavj2009@gmail.com", "pranav.jamadagni@way2automation.com" };
